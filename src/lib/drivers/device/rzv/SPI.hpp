...
// Make global variable for I2C event tracking accessible to C code
#ifdef __cplusplus
extern "C" {
#endif
// extern volatile i2c_master_event_t g_spi_event;
extern fsp_err_t validate_spi_event(void);
#ifdef __cplusplus
}
#endif
